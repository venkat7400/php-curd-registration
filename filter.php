    ...
    <div class="container">
        ...
        <div class="row">
            <div class="card mb-8 sm-4">
                ...
                <a href="form.php" class="btn btn-dark mb-3" >ADD NEW</a>
                <a href="add.php" class="btn  btn-primary mb-3" >DELETE/EDIT</a>
                <a href="index.php" class="btn btn-danger mb-3" >HOME</a>
                <a href="tech.php" class="btn btn-primary mb-3" >TECHNICAL EVENT</a>
                <a href="non_tech.php" class="btn btn-primary mb-3" >NON_TECHNICAL EVENT</a>
                <a href="non veg.php" class="btn btn-primary mb-3" >FOOD</a>
                <a href="pay.php" class="btn btn-primary mb-3" >PAYMENT</a>
                
                           
                    <h4 id="printremove" class="card-title">
                        SEARCH DATA..... TO  FILTER
                    </h4>
                        ...
                        <table class=" table table-bodered mb-8 ">
                          ...
                          <tbody>
                            ...
                            if(isset($_POST['filter_btn']))
                            {
                                ...
                                $query = "SELECT * FROM `student_data` WHERE CONCAT(`first_name`, `collage_name`,`department`, `email`,`phone_number`, `gender`,`tech`,`non_tech`,`food`,`pay`)LIKE  '%$value_filter%' ";
                                ...
                                else
                                {
                                   ?>
                                   <tr>
                                   <td colspan="10">NO RECORD FOND</td>
                                    </tr>
                                    <?php
